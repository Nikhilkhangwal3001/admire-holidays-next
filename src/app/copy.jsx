...
const states = [
  { name: "Andhra Pradesh", icon: "/icons/andhra.png",link: "andhra-pardesh/best-location" },
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
          {states.map((state, index) => (
            ...
            >
              ...
              <Link to={state.link}><p className="text-lg font-semibold text-gray-800 hover:underline">{state.name}</p></Link>
            </div>
          ))}
        </div>
      </div>
